/* Desk Page: Panduan Persediaan. Thin shell over the shared
...
frappe.pages["stock-guide"].on_page_load = function (wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: __("Panduan Persediaan"),
        single_column: true,
    });
    var tries = 0;
    (function mount() {
        if (window.VernonDeskGuides) return window.VernonDeskGuides.render(page.main, "stock");
        if (++tries > 50) {
