/* Desk Page: Panduan Pembelian. Thin shell over the shared
...
frappe.pages["purchase-guide"].on_page_load = function (wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: __("Panduan Pembelian"),
        single_column: true,
    });
    var tries = 0;
    (function mount() {
        if (window.VernonDeskGuides) return window.VernonDeskGuides.render(page.main, "purchase");
        if (++tries > 50) {
